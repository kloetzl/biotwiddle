...
\textbf{Figure \ref{fig:gccontent}. Computing the GC-Content.} Note the truncated y-axis. Todo: cut the y-axis.
}
...
The~simple~way~of~counting transversions~cannot be vectorized and thus is about ten times slower than counting only mutations. However, the new twiddling method presented in Section~\ref{sec:transversions} can be vectorized, an thus is almost as the first method.
